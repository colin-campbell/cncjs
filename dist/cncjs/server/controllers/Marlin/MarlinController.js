...
var MarlinController = /*#__PURE__*/function () {
  ...
  function MarlinController(engine, options) {
      ...
      writeFilter: function writeFilter(data, context) {
        ...
        (0, _interpret["default"])(line, function (cmd, params) {
          ...
          if ((0, _includes2["default"])(['M7', 'M8', 'M9'], cmd)) {
            var coolant = nextState.modal.coolant;

            // M7: Mist coolant, M8: Flood coolant, M9: Coolant off, [M7,M8]: Both on
            if (cmd === 'M9' || coolant === 'M9') {
              nextState.modal.coolant = cmd;
            } else {
              nextState.modal.coolant = (0, _uniq2["default"])((0, _ensureType.ensureArray)(coolant).concat(cmd)).sort();
    ...
    this.queryTimer = setInterval(function () {
      ...
      var zeroOffset = (0, _isEqual2["default"])(_this.runner.getPosition(_this.state), _this.runner.getPosition(_this.runner.state));
