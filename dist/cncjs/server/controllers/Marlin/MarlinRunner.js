...
var MarlinRunner = /*#__PURE__*/function (_events$EventEmitter) {
  ...
  function MarlinRunner() {
    ...
    _defineProperty(_assertThisInitialized(_this), "state", {
      ...
      // { deg, degTarget, power }
      hotend: {},
      // { T0: { deg, degTarget, power }, T1: { deg, degTarget, power }, ... }
      rapidFeedrate: 0,
      // Related to G0
      feedrate: 0,
    ...
    value: function parse(data) {
      ...
      if (type === _MarlinLineParserResultTemperature["default"]) {
        var _nextState = _objectSpread(_objectSpread({}, this.state), {}, {
          ...
          hotend: _objectSpread(_objectSpread({}, this.state.hotend), payload.hotend)
        });
        if (!(0, _isEqual2["default"])(this.state.extruder, _nextState.extruder) || !(0, _isEqual2["default"])(this.state.heatedBed, _nextState.heatedBed) || !(0, _isEqual2["default"])(this.state.hotend, _nextState.hotend)) {
