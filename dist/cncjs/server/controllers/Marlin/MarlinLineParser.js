...
var MarlinLineParser = /*#__PURE__*/function () {
  ...
  _createClass(MarlinLineParser, [{
    ...
    value: function parse(line) {
      var parsers = [
      // start
      _MarlinLineParserResultStart["default"],
      ...
      _MarlinLineParserResultFirmware["default"],
      // X:0.00 Y:0.00 Z:0.00 E:0.00 Count X:0 Y:0 Z:0
      _MarlinLineParserResultPosition["default"],
      // ok
      _MarlinLineParserResultOk["default"],
      // echo:
      _MarlinLineParserResultEcho["default"],
      // Error:Printer halted. kill() called!
      _MarlinLineParserResultError["default"],
