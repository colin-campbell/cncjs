...
var MarlinLineParserResultPosition = /*#__PURE__*/function () {
  function MarlinLineParserResultPosition() {
    _classCallCheck(this, MarlinLineParserResultPosition);
  }
  _createClass(MarlinLineParserResultPosition, null, [{
    key: "parse",
    value:
    // X:0.00 Y:0.00 Z:0.00 E:0.00 Count X:0 Y:0 Z:0
    // X:20.000 Y:41.000 Z:38.000 A:34.000 B:24.000 C:17.000 Count X:9311 Y:18922 Z:15200 A:536 B:378 C:268
    function parse(line) {
      var r = line.match(/^(?:(?:X|Y|Z|A|B|C|E):[0-9\.\-]+\s+)+/i);
      if (!r) {
        return null;
      }
      var payload = {
      ...
      var pattern = /((X|Y|Z|A|B|C|E):[0-9\.\-]+)+/gi;
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (nv) {
            ...
            var pos = nv[2];
            var digits = (0, _decimalPlaces["default"])(pos);
...
var _default = MarlinLineParserResultPosition;
