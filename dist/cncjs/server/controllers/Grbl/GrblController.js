      ...
      if (_this.workflow.state === _Workflow.WORKFLOW_STATE_RUNNING) {
        ...
        if (error) {
          ...
          if (pauseError) {
            _this.workflow.pause({
              err: true,
              msg: "error:".concat(code, " (").concat(error.message, ")")
            });
          }
        } else {
          // Grbl v0.9
  ...
  _createClass(GrblController, [{
    ...
    value: function command(cmd) {
      ...
      var handler = {
        ...
        'gcode:stop': function () {
          var _gcodeStop = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
