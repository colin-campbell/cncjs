  ...
  _createClass(GrblRunner, [{
    ...
    value: function parse(data) {
      ...
      if (type === _GrblLineParserResultAlarm["default"]) {
        var alarmPayload = {
          activeState: _constants.GRBL_ACTIVE_STATE_ALARM
        };
        var _nextState = _objectSpread(_objectSpread({}, this.state), {}, {
          status: _objectSpread(_objectSpread({}, this.state.status), alarmPayload)
        });
        if (!(0, _isEqual2["default"])(this.state.status, _nextState.status)) {
      ...
      if (type === _GrblLineParserResultParserState["default"]) {
        ...
        var _nextState2 = _objectSpread(_objectSpread({}, this.state), {}, {
          parserstate: {
            modal: modal,
            tool: tool,
            feedrate: feedrate,
        ...
        if (!(0, _isEqual2["default"])(this.state.parserstate, _nextState2.parserstate)) {
