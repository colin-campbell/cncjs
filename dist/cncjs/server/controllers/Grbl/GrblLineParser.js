...
var GrblLineParser = /*#__PURE__*/function () {
  ...
  _createClass(GrblLineParser, [{
    ...
    value: function parse(line) {
      var parsers = [
      // <>
      _GrblLineParserResultStatus["default"],
      // ok
      _GrblLineParserResultOk["default"],
      // error:x
      _GrblLineParserResultError["default"],
      // ALARM:
      _GrblLineParserResultAlarm["default"],
      // [G38.2 G54 G17 G21 G91 G94 M0 M5 M9 T0 F20. S0.] (v0.9)
      // [GC:G38.2 G54 G17 G21 G91 G94 M0 M5 M9 T0 F20. S0.] (v1.1)
      _GrblLineParserResultParserState["default"],
      ...
      _GrblLineParserResultParameters["default"],
      // [HLP:] (v1.1)
      _GrblLineParserResultHelp["default"],
      // [VER:] (v1.1)
      _GrblLineParserResultVersion["default"],
      // [OPT:] (v1.1)
      _GrblLineParserResultOption["default"],
      // [echo:] (v1.1)
      _GrblLineParserResultEcho["default"],
      // [] (v0.9)
      // [MSG:] (v1.1)
      _GrblLineParserResultFeedback["default"],
      // $xx
      _GrblLineParserResultSettings["default"],
      // Grbl X.Xx ['$' for help]
